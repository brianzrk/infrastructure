...
CREATE TABLE `m_category` (
                              ...
                              `parent_id` varchar(64) DEFAULT NULL COMMENT '父级分类的ID',
...
CREATE TABLE `m_comment` (
                             ...
                             `parent_id` varchar(64) DEFAULT NULL COMMENT '回复的评论ID',
                             `post_id` varchar(64) NOT NULL COMMENT '评论的内容ID',
                             `user_id` varchar(64) NOT NULL COMMENT '评论的用户ID',
                             ...
                             `created_time` datetime NOT NULL COMMENT '评论的时间',
                             `modified_time` datetime DEFAULT NULL COMMENT '评论的更新时间',
                             PRIMARY KEY (`id`)
...
-- Records of m_post
-- ----------------------------
INSERT INTO `m_post` VALUES ('1', 'Github上最值得学习的100个Java开源项目，涵盖各种技术栈！', '摘要1', ' 你有多久没好好学习一个开源项目了？\n\n你是否经常为找不到好的开源项目而烦恼？\n\n你是否为不知道怎么入手去看一个开源项目？\n\n你是否想看别人的项目学习笔记？\n\n你是否想跟着别人的项目搭建过程一步一步跟着做项目？\n\n为了让更多Java的开发者能更容易找到值得学习的开源项目，我搭建了这个Java开源学习网站，宗旨梳理Java知识，共享开源项目笔记。来瞧一瞧：\n\nimg[//image-1300566513.cos.ap-guangzhou.myqcloud.com/upload/images/20200414/473f73a3eb6f471e8154620a9c1d5306.png] \n\n网站截图中可以看出，点击筛选条件组合之后，再点击搜索就会搜索出对应的开源项目。\n\n比如打开renren-fast项目，可以看到具体项目的信息，以及模块解析。\n\nimg[//image-1300566513.cos.ap-guangzhou.myqcloud.com/upload/images/20200414/f74740692dab4d9c937cd56336ead1b4.png]\n\n这样，学习一个开源项目就不再费劲，每天学习一个开源项目，在不知不觉中提升技术水平！目前网站已经收录了近100个开源项目，让Java不再难懂！\n\n直接扫公众号下方的二维码，回复关键字【网站】即可获得网站的域名地址！\n\nimg[//image-1300566513.cos.ap-guangzhou.myqcloud.com/upload/images/20200414/f58f7c6d038c4dfb99bd9cf40935392e.png]\n\n关注上方的公众号二维码\n\n回复【网站】即可获取项目域名地址。\n', '0', '1', '1', '0', '0', '5', '0', '1', '1', null, '2020-04-28 14:41:41', '2020-04-28 14:41:41');
INSERT INTO `m_post` VALUES ('3', '111111111111', '摘要2','1222222222222222', '0', '1', '1', '0', '0', '1', '0', '0', '0', null, '2020-04-28 14:55:48', '2020-04-28 14:55:48');
INSERT INTO `m_post` VALUES ('4', '11111112222', '摘要3','1222222222222222', '0', '1', '1', '0', '0', '1', '0', '0', '0', null, '2020-04-28 14:55:48', '2020-04-28 14:55:48');
INSERT INTO `m_post` VALUES ('5', '114444444441', '摘要4','1222222222222222', '0', '1', '1', '0', '0', '1', '0', '0', '0', null, '2020-04-28 14:55:48', '2020-04-28 14:55:48');
INSERT INTO `m_post` VALUES ('7', '11111115555551', '摘要5','1222222222222222', '0', '1', '1', '0', '0', '1', '0', '0', '0', null, '2020-04-28 14:55:48', '2020-04-28 14:55:48');
INSERT INTO `m_post` VALUES ('66', '6666666', '摘要6','1222222222222222', '0', '1', '1', '0', '0', '1', '0', '0', '0', null, '2020-04-28 14:55:48', '2020-04-28 14:55:48');
INSERT INTO `m_post` VALUES ('asdf45fdasf51', '11111777777777111', '摘要7','1222222222222222', '0', '1', '1', '0', '0', '1', '0', '0', '0', null, '2020-04-28 14:55:48', '2020-04-28 14:55:48');
...
-- Records of m_user
-- ----------------------------
INSERT INTO `m_user` VALUES ('1', 'brian', 'cbd44f8b5b48a51f7dab98abcdf45d4e', '11111@qq.com', null, '0', '一起学Java！！', '0', null, '0', null, '/res/images/avatar/default.png', '0', '0', '0', '2020-04-28 14:54:11', '2020-04-28 14:37:24', null);
INSERT INTO `m_user` VALUES ('2', 'test007', 'cbd44f8b5b48a51f7dab98abcdf45d4e', '1111@qq.com', null, '0', null, '0', null, '0', null, '/res/images/avatar/default.png', '0', '0', '0', null, '2020-04-28 14:45:07', null);
INSERT INTO `m_user` VALUES ('3', 'test004', 'cbd44f8b5b48a51f7dab98abcdf45d4e', '144d11@qq.com', null, '0', null, '0', null, '0', null, '/res/images/avatar/default.png', '0', '0', '0', null, '2020-04-28 14:48:26', null);
INSERT INTO `m_user` VALUES ('4', 'test005', 'cbd44f8b5b48a51f7dab98abcdf45d4e', '144d15@qq.com', null, '0', null, '0', null, '0', null, '/res/images/avatar/default.png', '0', '0', '0', null, '2020-04-28 14:48:26', null);
INSERT INTO `m_user` VALUES ('5', 'test00756', 'cbd44f8b5b48a51f7dab98abcdf45d4e', '45454541@qq.com', null, '0', null, '0', null, '0', null, '/res/images/avatar/default.png', '0', '0', '0', null, '2020-04-28 14:53:49', null);
